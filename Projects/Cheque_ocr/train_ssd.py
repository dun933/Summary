...
def main():
    ...
    parser.add_argument('--log_step', default=12, type=int, help='Print logs every log_step')
    parser.add_argument('--save_step', default=12, type=int, help='Save checkpoint every save_step')
    parser.add_argument('--eval_step', default=120, type=int, help='Evaluate dataset every eval_step, disabled when eval_step < 0')
